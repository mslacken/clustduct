...
function create_pxe_node_file(node,handle,config) 
	...
	if node_args["mac"] ~= nil then 
		...
		if not file_exists(mac_filename) then
			local mac_file_out = "# Hardware specifc node file automatically generated by clustduct\nDEFAULT menu.c32\nAPPEND "..ofile_name
...
function create_grub_node_file(node,handle,config) 
	...
	if not file_exists(ip_filename) then
		local ip_file_out = "# IP sepcific configfile automatically generated by clustduct\nconfigfile "..ofile_name
